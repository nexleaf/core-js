...
Module [`esnext.promise.all-settled`](https://github.com/zloirock/core-js/blob/v3.8.3/packages/core-js/modules/esnext.promise.all-settled.js)
```js
class Promise {
  static allSettled(iterable: Iterable): Promise;
}
...
Modules [`esnext.array.at`](https://github.com/zloirock/core-js/blob/v3.8.3/packages/core-js/modules/esnext.array.at.js) and [`esnext.typed-array.at`](https://github.com/zloirock/core-js/blob/v3.8.3/packages/core-js/modules/esnext.typed-array.at.js)
...
Module [`esnext.string.at`](https://github.com/zloirock/core-js/blob/v3.8.3/packages/core-js/modules/esnext.string.at.js)
```js
class String {
